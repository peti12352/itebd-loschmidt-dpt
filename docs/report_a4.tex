...
A general state on $L$ spins requires $2^L$ complex amplitudes. For
low-entanglement states, this is compressed by writing the state as a matrix
product state (MPS). At any bipartition of the chain into left ($L$) and right
($R$) halves, the Schmidt decomposition gives
\begin{equation}
