...
nonzero eigenvalues, is precisely $\chi$. So $\chi$ is not an abstract index
count, it is the number of distinguishable outcomes a measurement on the left
half alone could ever produce, given everything the right half could be
